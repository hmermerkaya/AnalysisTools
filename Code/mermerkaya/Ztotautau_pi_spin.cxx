...
Ztotautau_pi_spin::Ztotautau_pi_spin(TString Name_, TString id_):
  Selection(Name_,id_)
  ,channel(muontag)
  ,muoneta(2.1)
  ,jeteta(2.3)
...
Ztotautau_pi_spin::~Ztotautau_pi_spin(){
  for(int j=0; j<Npassed.size(); j++){
    std::cout << "Ztotautau_pi_spin::~Ztotautau_pi_spin Selection Summary before: " 
	 << Npassed.at(j).GetBinContent(1)     << " +/- " << Npassed.at(j).GetBinError(1)     << " after: "
	 << Npassed.at(j).GetBinContent(NCuts) << " +/- " << Npassed.at(j).GetBinError(NCuts) << std::endl;
  }
  std::cout << "Ztotautau_pi_spin::~Ztotautau_pi_spin()" << std::endl;
}

void  Ztotautau_pi_spin::Configure(){
  // Setup Cut Values
...
void  Ztotautau_pi_spin::Store_ExtraDist(){
...
void  Ztotautau_pi_spin::doEvent(){
  unsigned int t;
  int id(Ntp->GetMCID());
  if(!HConfig.GetHisto(Ntp->isData(),id,t)){ std::cout << "failed to find id" <<std::endl; return;}

  if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() A" << std::endl;
  ...
  if(channel==muontag){
    ...
    if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() C" << std::endl;
    ...
    if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() C2 - " << mu_idx << " " << Ntp->NMuons() << std::endl;
  ...
  if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() d" << std::endl;
  ...
  if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() e" << std::endl;
  ...
  if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() g" << std::endl;

  if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() h" << std::endl;
  ...
  */
  if(verbose)std::cout << "void  Ztotautau_pi_spin::doEvent() i" << std::endl;
